...
<form method="post" action="{{ URL::route('post.create.proveedores') }}" class="form-horizontal">
        ...
        <div class="form-group">
          <div class="col-md-4">
            <label class="control-label">Nombre</label>
              <input type="text" pattern="|^[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ1234567890]*$|" maxlength="15" title="No se Admiten espacios ni caracteres especiales" required name="nombre" placeholder="Ingresar Nombre" class="form-control" ><br>
          </div>

          <div class="col-sm-4">
              <label class="control-label" for=""> Empresa</label>               
                <input type="text" required name="empresa" placeholder="Ingresar Empresa" class="form-control" ><br>                  
          </div>

          <div class="col-md-4">
            <label class="control-label">Teléfono</label>
              <input type="text" required name="telefono" maxlength="10" min="10" max="9999999999" placeholder="Ingresar Teléfono" class="form-control" ><br>
          </div>

          
          <div class="col-sm-4">
              <label class="control-label" for=""> Dirección</label>
                <input type="text" required name="direccion" placeholder="Ingresar Dirección" class="form-control" ><br>                
          </div>

          <div class="col-sm-4">
              <label class="control-label" for=""> Notas</label>
                <input type="text" required name="notas" placeholder="Ingresar Notas" class="form-control" ><br>                
          </div>
