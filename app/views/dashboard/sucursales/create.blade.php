...
@section ('contenido')      
		...
		<form method="post" action="{{ URL::route('post.create.sucursales') }}" class="form-horizontal">
			  ...
			  <legend>
				...
				<div class="form-group">
				  <div class="col-md-4">
					...
					<input type="text" required name="sucursal" placeholder="Ingresa Sucursal" class="form-control" ><br>
				  </div>
