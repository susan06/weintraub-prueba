...
<form method="post" action="{{ URL::to('dashboard/unidades/'.$unidades->id.'/edit/') }}" class="form-horizontal">
      ...
      <legend>
        ...
        <div class="form-group">
          <div class="col-md-4">
            ...
            <input type="text" required name="unidad" placeholder="Ingresa Unidad" class="form-control" value="{{$unidades->nombre}}" ><br>
          </div>
          ...
          <div class="col-sm-4">
              <label class="control-label" for=""> Abreviatura</label>
                <div class="input-group">
                     ...
                     <input type="text" required name="abreviatura" placeholder="Ingresa Abreviatura" class="form-control" value="{{$unidades->abreviatura}}"><br>
