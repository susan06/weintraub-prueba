...
<form method="post" action="{{ URL::route('post.create.materias') }}" class="form-horizontal">
      ...
      <legend>
        ...
        <div class="form-group">
          <div class="col-md-4">
            ...
            <input type="text" required name="nombre" placeholder="Ingresar nombre" class="form-control" ><br>
          </div>
          ...
          <div class="col-sm-4">
              <label class="control-label" for=""> Unidad</label>
                <div class="input-group">
                    ...
                    <option value="{{$und->id}}" @if(Input::old('id') == $und->id) selected @endif > {{$und->nombre}}</option>
                    @endforeach
                    </select>
                    @else
                    <select class="form-control" required name="unidad">
                    <option value="" >No ha Agregado Unidades</option>
                    </select>
                    @endif
                </div>
          </div>
