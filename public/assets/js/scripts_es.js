    ...
    $(document).ready(function () {
        ...
        if ($('#available-validations').length) {
            ...
            $("#available-validations").validate({
                ...
                messages: {
                    required: {
                        required: 'Por favor, ingrese algo'
                    },
                    email: {
                        required: 'Por favor, ingrese su email'
                    },
                    url: {
                        required: 'Por favor, ingrese su URL'
                    },
                    date3: {
                        required: 'Por favor, ingrese alguna fecha en formato dd/mm/aaaa'
                    },
                    min: {
                        required: 'Por favor, ingrese algún texto'
                    },
                    max: {
                        required: 'Por favor, ingrese algún texto'
                    },
                    ...
                    digits: {
                        required: 'Por favor, ingrese algunos digítos'
                    },
                    number: {
                        required: 'Por favor, ingrese algún número'
                    },
                    minVal: {
                        required: 'Por favor, ingrese algún valor'
                    },
                    maxVal: {
                        required: 'Por favor, ingrese algún valor'
                    },
        ...
        if ($('#checkout-form').length) {
            $('#checkout-form').validate({
                ...
                messages: {
                    ...
                    name: {
                        required: 'Por favor, ingrese el nombre en su tarjeta'
                    },
                    card: {
                        required: 'Por favor, ingrese el número de su tarjeta'
                    },
                    cvv: {
        ...
        if ($('#order-form').length) {
            $("#order-form").validate({
                ...
                messages: {
                    ...
                    interested: {
                        required: 'Por favor, seleccione el servicio que le interesa'
                    },
                    budget: {
                        required: 'Por favor, seleccione su presupuesto'
                    }
                },
        ...
        if ($('#registration-form').length) {
            $("#registration-form").validate({
                ...
                messages: {
                    ...
                    name_street: {
                        required: 'Por favor, seleccione la calle donde vive'
                    },
                    name_floor: {
                        required: 'Por favor, seleccione el piso donde vive  '
                    },

                    num_house_or_apartment: {

                        required: 'Por favor, ingrese el número de su vivienda'
                    },
                    phone: {
                        required: 'Por favor, ingrese su número telefónico',
                        number	: 'Por favor, Ingrese dígitos solamente.'
                    },
                },
        ...
        if ($('#review-form').length) {
            $("#review-form").validate({
                ...
                messages: {
                    ...
                    review: {
                        required: 'Por favor, introduzca su opinión'
                    },
                    quality: {
                        required: 'Por favor, puntúa la calidad del producto'
                    },
                    reliability: {

                        required: 'Por favor, califica la fiabilidad del producto'
                    },
                    overall: {
                        required: 'Por favor, califica el producto'
                    }
                },
            ...
            $('#steps-wizard').validate({
                ...
                messages: {
					admin_name: {
					 ...
					 admin_phone: {
                        required: 'Por favor, introduzca su número de télefono'
                    },
                    location: {
                        required: 'Por favor, introduzca el nombre de las calles o pisos de la colonia'
                    },
                    monthly_fee: {
                        required: 'Por favor, introduzca el monto correspondiente a la cuota mensual de pago de la colonia',
                        number: 'Por favor, Ingrese dígitos solamente.'
                    },
                    email: {
                        required: 'Por favor, Ingrese E-mail del vecino.',
                        email: 'Por favor, ingrese una dirección VÁLIDA de email.'
                    },
                    phone: {
                        required: 'Por favor, Ingrese su número telefónico'
                    ...
                    colony_name: {
                        required: 'Por favor, Ingrese el nombre de su colonia'
                    },
                    urbanism_type: {
                        required: 'Por favor, Seleccione el tipo de urbanismo'
                    },
                    urbanism_name: {
                        required: 'Por favor, Ingrese el nombre del urbanismo'
                    },
                    code: {
                        required: 'Por favor, ingrese código',
                        digits: 'Sólo dígitos por favor'
